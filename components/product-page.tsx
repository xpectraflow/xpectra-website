    ...
    return (
        <div className="w-full p-12 bg-card-bg border border-border-subtle rounded-[3rem] backdrop-blur-3xl overflow-hidden relative group">
            <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-12">
                ...
                {/* Consumer */}
                <div className="flex flex-col items-center gap-4">
                    <div className="w-24 h-24 rounded-3xl bg-white flex items-center justify-center shadow-2xl shadow-white/20 p-5">
                        <Image src="/logo.svg" alt="Xpectra" width={64} height={64} className="brightness-100" />
                    </div>
                    <div className="text-center">
                ...
                <div className="flex flex-col items-center gap-4">
                    ...
                    <div className="text-center">
                        ...
                        <p className="text-[10px] font-mono text-white/30 uppercase mt-1">XpectraDB</p>
                    </div>
                </div>
                ...
                <div className="flex flex-col items-center gap-4">
                    ...
                    <div className="text-center">
                        ...
                        <p className="text-[10px] font-mono text-white/30 uppercase mt-1">Web UI</p>
                    </div>
                </div>
            </div>
